...
<title>Feedback | Son Duong</title>
<link rel="stylesheet"
	href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.css" />
<link
	href="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.7/css/materialize.css"
	rel="stylesheet">
<style type="text/css">
...
.navbar .active>a, .navbar-default .navbar-nav>.active>a:hover,
...
input:not ([type] ):focus:not ([readonly] ) +label, input[type=text]:focus:not
	...
	input[type=date]:focus:not ([readonly] ) +label, input[type=datetime]:focus:not
	 ([readonly] ) +label, input[type=datetime-local]:focus:not ([readonly]
	 ) +label, input[type=tel]:focus:not ([readonly] ) +label, input[type=number]:focus:not
...
.overallRatings>input:checked ~ label:before, .overallRatings>input+label:hover 
	 ~ label:before, .overallRatings>input+label:hover:before {
	content: "★";
	color: #ffeb3b;
					...
					<form action="addFeedback" method="get">
						...
						<div class="row header">
							<div class="input-field col s12 navbar-collapse" align="center">
								...
								<p>
								<center>Your Feedback Matters</center>
								</p>
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s12">
								<input id="name" name="name" pattern="[A-Za-z]{2,}"
									title="Two or more characters" type="text" class="validate"
						...
						<div class="row">
							<div class="input-field col s12">
								<input id="email" name="email"
									...
									title="Invalid Email Address" type="text" class="validate"
...
<option value="3">Online Course</option>
								...
								<input id="reg" name="reg" title="Two or more characters"
									type="text" class="validate" data-error="#e1" required>
						...
						<div class="row">
							<div class="input-field col s12">
								<textarea pattern=".{1,}" title="One or more characters"
									id="msg" name="msg" class="materialize-textarea"
									data-error="#e4" required></textarea>
						...
						<div class="row">
							<div class="input-field col m6 s12">
								<button type="reset" value="reset"
									class="waves-effect waves-light btn-large navbar-right">Reset</button>
							</div>
							<div class="input-field col m6 s12">
	...
	<form action="getFeedbacks" method="get">
		<div class="row">
			<div class="input-field col m6 s12">
				<button type="submit" class="waves-effect waves-light btn-large">Get
					Feedbacks</button>
			</div>
		</div>
	</form>
